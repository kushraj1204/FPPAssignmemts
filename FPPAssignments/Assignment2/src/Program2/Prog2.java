...
public class Prog2 {
    public static void main(String[] args) {
        ...
        listProductIds(records);

    }
    public static void listProductIds(String records){
        String[] recordArray=records.split(":");
        String[] productIds=new String[recordArray.length];

        for (int i = 0; i < recordArray.length; i++) {
            productIds[i]=(recordArray[i].split(","))[0];
        }
